...
The **xcsh Chrome Extension** is a purpose-built Manifest V3 extension that lets the [xcsh](https://f5xc-salesdemos.github.io/xcsh/) AI assistant drive the F5 Distributed Cloud admin console directly in your browser — deterministically, in headed mode, while you watch.
...
1. Install the [xcsh CLI](https://f5xc-salesdemos.github.io/xcsh/)
...
The extension is open source at [github.com/f5xc-salesdemos/xcsh-chrome-extension](https://github.com/f5xc-salesdemos/xcsh-chrome-extension).
